        ...
        <div class="p-4">
            <form action="{{ url('back/users') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nickname" id="nickname" class="w-full p-2 border rounded @error('nickname') border-red-500 @enderror" value="{{ old('nickname') }}">
                    @error('nickname')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="full_name" id="full_name" class="w-full p-2 border rounded @error('full_name') border-red-500 @enderror" value="{{ old('full_name') }}">
                    @error('full_name')
                    <div class="text-red-500 mt-2 text-sm">
                        {{ $message }}
                    </div>
                ...
                <div class="flex justify-end mt-4">
                    <button type="button" class="bg-gray-500 text-white px-4 py-2 rounded mr-2 close-modal" data-bs-target="#modalCreate">Gak dlu</button>
