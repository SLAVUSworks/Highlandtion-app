...
<div class="container mx-auto p-6" x-data="{ openCreateModal: false, openEditModal: false, editId: '', editName: '', editIcon: '' }">
    ...
    <button @click="openCreateModal = true" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
        Tambah Kategori
    </button>

    {{-- Modal Create --}}
    <div x-show="openCreateModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            ...
            <tbody>
                ...
                <tr class="border-t hover:bg-gray-100 transition">
                    ...
                    <td class="px-4 py-2 text-center">
                        ...
                        <form action="{{ route('back.menu-category.destroy', $category->id) }}" method="POST" class="inline-block">
                            @csrf
                            @method('DELETE')
