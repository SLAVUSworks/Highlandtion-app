...
<div class="w-full max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 space-y-6">
    ...
    <div class="border-t border-gray-200 pt-4">
        @if ($menu->status === 'tutup')
            <!-- Tombol untuk status "tutup" -->
            <a href="/" 
               class="block w-full bg-gray-400 text-gray-700 text-center text-lg font-semibold py-3 rounded-lg cursor-not-allowed">
                Pendaftaran Bidang ini Telah Ditutup
            </a>
        @else
            <!-- Tombol untuk status "buka" -->
