...
<body>
    <nav class="bg-gray-800 p-4">
        <div class="container mx-auto flex justify-between items-center">
            <a id="top-title" href="/" class="text-white text-lg font-semibold">{{ $config['app_name'] }}</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-2 space-y-2">
            ...
            <a href="/contact" class="block text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Kontak</a>
        </div>
    </nav>
