    ...
    <nav class="fixed top-0 left-0 w-full bg-gray-800 p-4 z-50 shadow-lg">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div id="menu" class="hidden md:flex space-x-4">
                ...
                <a href="{{ route('registrasi.track') }}" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Track Registrasi</a>
                ...
                <a href="{{ route('contact.show') }}" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Kontak</a>
            </div>
        </div>
        <div id="mobile-menu" class="hidden md:hidden mt-2 space-y-2">
            ...
            <a href="{{ route('registrasi.track') }}" class="block text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Track Registrasi</a>
            ...
            <a href="{{ route('contact.show') }}" class="block text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Kontak</a>
        </div>
    </nav>
    ...
    <footer class="bg-gray-800 text-white py-8" data-aos="fade-up">
        <div class="container p-5 mx-auto">
            ...
            <div class="flex justify-end items-center mt-8">
                <p class="text-sm text-right">HL-Web App n Booking System v2.14<br>
