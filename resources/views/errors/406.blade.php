...
@section('content')
        <div class="w-56 sm:w-64 border-4 border-white/80 p-2 rounded-xl shadow-xl float">
            <img src="https://c.tenor.com/lPVf0QcafhEAAAAC/stop-right-there-buster-nope.gif"
                 alt="406"
        ...
        <p class="mt-2 text-sm sm:text-base text-white/80 max-w-md">
            Server tidak dapat menghasilkan respons yang sesuai dengan kriteria yang ditentukan.
        </p>
